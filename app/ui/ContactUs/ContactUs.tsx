...
export default function ContactUs () {
  return (
    <div className="w-full h-full flex-col justify-center items-start gap-5 inline-flex">
      ...
      <div className="w-full h-full justify-center items-start gap-5 inline-flex">
        <div className="w-1/2 h-full flex-col justify-start items-start gap-5 inline-flex">
          <Form/>
        </div>
        <div className="w-1/2 h-full flex-col justify-end items-center gap-5 inline-flex pt-5">
